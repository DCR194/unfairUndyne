...
//gcc bin2c_32bit.c -o test
//./test name.wav file outpu
//./test sound.wav soundarray.c myArray
...
//Documents\TORONTO\Second Year\SECOND SEM\Computer Organization\Project\C_Audio_Array